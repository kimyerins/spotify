    ...
    <div className={"flex justify-center mx-2"}>
      <div className={"main max-w-[2100px]"}>
        <div className={"flex mt-1 px-5"}>
          <button
            className={
              "h-8 px-4 bg-[rgb(37,37,37)] rounded-full text-[rgb(174,174,174)] mx-1 hover:bg-[rgb(214,214,214)] hover:text-black"
            }
          >
            {filterTitle.all}
          </button>
        ...
        <div
          className={
            "card-div text-white mx-1 mt-10 px-5 w-[calc(100vw-800px)] min-w-[560px] max-w-[1900px]"
          }
        >
          {genre &&
            combinedGenre().map((item, index) => (
