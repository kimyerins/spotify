    ...
    return (
        <div className={'w-[100%] ArtistInfoPage overflow-hidden rounded-[10px] bg-[#121212] mr-2'} style={{ color: 'white'}}>
            ...
            <div className={'w-[100%] h-calc-100vh-minus-5rem'}>
                ...
                {/* 콘텐츠 */}
                <div className={'w-[100%] h-svh info-container relative overflow-y-scroll overflow-x-clip'}>
                    {/* 상단 타이틀 */}
                    ...
                    <div className={'p-4 flex items-center gap-4 bg-[#121212]'}>
                        ...
                        <button className={'px-4 py-1.5 rounded-full text-sm font-bold border border-solid border-[#656565] hover:border-white'}>팔로우하기</button>
                        {/* Popup Menu */}
                        <div className={'relative'}>
                            <button aria-hidden="true" className={'text-8xl font-extrabold'} onClick={togglePopup}>
                                <svg
                                role="img"
                                aria-hidden="true"
                                viewBox="0 0 24 24"
                                className={'w-8 h-8 text-[#656565] hover:text-white  transition-all duration-250 ease-in-out'}
                                fill="currentColor"
                                >
                            ...
                            {popupVisible && (
                                <div className={'menu-popup w-[220px] absolute top-10 left-0 overflow-hidden rounded-[5px]'}>
                                    <ul className={'p-1 bg-[#282828]'}>
                                        <li className={'p-3 bg-[#282828] hover:bg-[hsla(0,0%,100%,.1)] overflow-hidden rounded-[2px]'}>
                                            <button className={'flex items-center gap-2'}>
                                                <svg role="img" aria-hidden="true" viewBox="0 0 16 16" className={'w-4 h-4'} fill="#b3b3b3">
                                                ...
                                                <span className={'text-sm text-white font-semibold tracking-tighter opacity-90'}>팔로우하기</span>
                                            </button>
                                        </li>
                                        <li className={'p-3 bg-[#282828] hover:bg-[hsla(0,0%,100%,.1)] overflow-hidden rounded-[2px]'}>
                                            <button className={'flex items-center gap-2'}>
                                                ...
                                                <span className={'text-sm text-white font-semibold tracking-tighter opacity-90'}>이 아티스트 재생 안 함</span>
                                            </button>
                                        </li>
                                        <li className={'p-3 bg-[#282828] hover:bg-[hsla(0,0%,100%,.1)] overflow-hidden rounded-[2px]'}>
                                            <button className={'flex items-center gap-2'}>
                                                ...
                                                <span className={'text-sm text-white font-semibold tracking-tighter opacity-90'}>아티스트 라디오 보러가기</span>
                                            </button>
                                        </li>
                                        <li className={'p-3 bg-[#282828] hover:bg-[hsla(0,0%,100%,.1)] overflow-hidden rounded-[2px]'}>
                                            <button className={'w-full flex items-center justify-between gap-2'}>
                                                <div className={'flex items-center gap-2'}>
                                                    ...
                                                    <span className={'text-sm text-white font-semibold tracking-tighter opacity-90'}>신고하기</span>
                                                </div>
                                                <span>
                                                    <svg role="img" aria-hidden="true" viewBox="0 0 16 16" className={'w-4 h-4 rotate-90'} fill="hsla(0,0%,100%,.9)">
                                        ...
                                        <li className={'p-3 bg-[#282828] hover:bg-[hsla(0,0%,100%,.1)] overflow-hidden rounded-[2px]'}>
                                            <button className={'w-full flex items-center justify-between gap-2'}>
                                                <div className={'flex items-center gap-2'}>
                                                    ...
                                                    <span className={'text-sm text-white font-semibold tracking-tighter opacity-90'}>공유</span>
                                                </div>
                                                <span>
                                                    <svg role="img" aria-hidden="true" viewBox="0 0 16 16" className={'w-4 h-4 rotate-90'} fill="hsla(0,0%,100%,.9)">
                                                        <path d="M14 10 8 4l-6 6h12z" />
                                        ...
                                        <li className={'p-3 border-t border-[hsla(0,0%,100%,.1)] hover:bg-[hsla(0,0%,100%,.1)] overflow-hidden rounded-[2px]'}>
                                            <button className={'flex items-center gap-2'}>
                                                <svg role="img" aria-hidden="true" viewBox="0 0 16 16" className="w-4 h-4 text-gray-500" fill="#b3b3b3">
                                                ...
                                                <span className={'text-sm text-white tracking-tighter opacity-90'}>데스크톱 앱에서 열기</span>
                                            </button>
                                        </li>
                                    </ul>
                                </div>
