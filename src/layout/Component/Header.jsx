                ...
                <Link to='/search'>
                    <div className={`search-box flex gap-4 items-center bg-[#1f1f1f] text-white rounded-full px-4 py-2 h-12 w-[474px] cursor-pointer hover:bg-[#404040] ${isFocused ? 'border-2 border-white' : ''}`}>
                        <svg className='self-center w-6 h-6' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#b3b3b3">
                            <path d="M16.6725 16.6412L21 21M19 11C19 15.4183 15.4183 19 11 19C6.58172 19 3 15.4183 3 11C3 6.58172 6.58172 3 11 3C15.4183 3 19 6.58172 19 11Z" stroke="#b3b3b3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        ...
                        <svg className={`self-center w-6 h-6 hover:stroke-white pl-2 border-l-[1px] border-solid border-[#b3b3b3] ${isFocused ? 'fill-white stroke-none' : ''}`}
                    ...
                    isAuthenticate ?
                            ...
                            {isDropdownOpen && (
                                <div className="absolute right-0 top-14 z-10 bg-[#282828] divide-y divide-[#464646] rounded-lg shadow w-44">
                                    <ul className="py-2 text-sm bg-[#282828] text-[#eaeaea] rounded-[4px]">
                                        <li>
                                            <Link to="/" className="block px-4 py-2 hover:bg-[#464646]">계정</Link>
                                        </li>
                                        <li>
                                            <Link to="/" className="block px-4 py-2 hover:bg-[#464646] ">프로필</Link>
                                        </li>
                                        <li>
                                            <Link to="/" className="block px-4 py-2 hover:bg-[#464646]">설정</Link>
                                        </li>
                                    </ul>
                                    <div className="py-1">
                                        <div className="block px-4 py-2 text-sm bg-[#282828] hover:bg-[#464646] cursor-pointer" onClick={() => setAuthenticate(false)}>로그아웃</div>
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        <div>
                            <a href='https://www.spotify.com/kr-ko/signup?forward_url=https%3A%2F%2Fopen.spotify.com%2F'>
                                <button type="button" className="py-2.5 px-5 me-2 mb-2 text-base font-semibold text-[#969696] focus:outline-none bg-transparent rounded-full 
                            hover:scale-105 hover:text-white">가입하기</button>
                            </a>
                            <button type="button" className="py-2.5 px-5 me-2 mb-2 text-base font-semibold text-gray-900 focus:outline-none bg-white rounded-full 
                            hover:scale-105 hover:bg-slate-50"
                                onClick={() => setAuthenticate(true)}>로그인하기</button>
                        </div>
                }
            </div>
        </div>
